...
from app.emails.booking_confirmation import _format_appointment_datetime
...
def test_formatting():
    ...
    formatted = _format_appointment_datetime(dt_utc, duration_minutes=duration)
    ...
    formatted_no_duration = _format_appointment_datetime(dt_utc)
